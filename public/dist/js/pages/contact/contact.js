...
getNameInput && getNameInput.addEventListener("input", function () {
...
getEmailInput && getEmailInput.addEventListener("input", function () {
...
getPhoneInput && getPhoneInput.addEventListener("input", function () {
