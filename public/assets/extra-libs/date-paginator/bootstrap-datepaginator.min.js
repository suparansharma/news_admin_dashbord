!(function (t, e, i, s) {
  ...
  (o.defaults = {
    ...
    (o.prototype = {
      ...
      _template: {
        list: '<ul className="pagination"></ul>',
        listItem: "<li></li>",
        navItem: '<a href="#" className="dp-nav"></a>',
        dateItem: '<a href="#" className="dp-item"></a>',
        icon: '<i className="glyphicon"></i>',
        calendar: '<i id="dp-calendar" className="ti-calendar"></i>',
      },
